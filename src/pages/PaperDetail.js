...
const PaperDetail = () => {
    ...
    return (
        <main className="max-w-5xl mx-auto px-6 py-12 md:py-16">
            <header className="mb-24">
                <Link to="/ideas" className="inline-block mb-8 text-xs font-bold uppercase tracking-widest text-text-muted no-underline hover:text-text-heading transition-colors">← Back to Ideas</Link>
                <h1 className="text-3xl md:text-4xl font-bold tracking-tightest mb-2 text-text-heading">{paper.title}</h1>
                <p className="text-text-muted italic opacity-80">{paper.author} — {paper.date}</p>
            </header>
