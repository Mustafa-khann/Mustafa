...
const PaperDetail = () => {
  ...
  return <ArticleLayout recordKey={paper.id} title={copy?.title || paper.title} summary={copy?.summary || paper.abstract} category="Research" backTo="/ideas" date={paper.date} meta={paper.author} html={preparePostHtml(paper.content)} contents />;
};
